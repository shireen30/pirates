...
function preload(){
  ...
  background_sound=loadSound("pirates.mp3");
...
wallbottom=createSprite(750,800,1500,20);
wallbottom.shapeColor="green"
walltop=createSprite(750,0,1500,20);
walltop.shapeColor="green"
...
wallbottom.visible=false
 ...
 wall20=createSprite(40,300,80,10)
...
function draw() {
 ...
 // console.log(mouseX,mouseY);
  ...
  skeleton1.bounceOff(wallbottom);
  skeleton1.bounceOff(walltop);

  skeleton2.bounceOff(wallbottom);
  skeleton2.bounceOff(walltop);

  skeleton3.bounceOff(wallbottom);
  skeleton3.bounceOff(walltop);

  
  skeleton.bounceOff(wallbottom);
  skeleton.bounceOff(walltop);
  ...
  if(frameCount%80==0){
    skeleton2.x=Math.round(random(250,500))
  }
  ...
  pirate.bounceOff(wall19);
  pirate.bounceOff(wall20);
